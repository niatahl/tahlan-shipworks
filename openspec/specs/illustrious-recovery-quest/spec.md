# illustrious-recovery-quest Specification

## Purpose

Louisa Ferre's one-time Illustrious recovery questline: a COOPERATIVE-gated quest offered alongside her existing devil missions, structured as a three-hop guarded Nightwatch clue chain with escalating faceless Legio opposition, culminating in the peaceful salvage of a drifting Illustrious bearing exactly three D-mods, followed by a one-time discounted paid restoration that clears those D-mods.
