...
public class regaliablueprintintel extends BaseIntelPlugin {
    ...
    private regaliablueprintscript script;

    //The stage of the event we are currently at
    protected QUEST_STAGE stage;

    //Initializer function
    public regaliablueprintintel(regaliablueprintscript script) {
        this.script = script;
    ...
    protected void addBulletPoints(TooltipMakerAPI info, ListInfoMode mode) {
        ...
        if (stage != QUEST_STAGE.END_OF_BLUEPRINTS) {
            ...
            info.addPara("You've succesfully recovered all intact data from the %s databanks. Furthermore you have found information that an object of interest might be hidden in the " + Global.getSector().getMemoryWithoutUpdate().getString("$traum_location") + " constellation", initPad, h, "Halbmond's", Global.getSector().getMemory().getString("$tahlan_traum_location"));
        }
