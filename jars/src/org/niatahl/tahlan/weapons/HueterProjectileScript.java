...
public class HueterProjectileScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public HueterProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
