...
import org.niatahl.tahlan.weapons.rotaryAnimation;
...
public class BreakerMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {

    private rotaryAnimation rotaryScript = null;
    ...
    */
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("FLASH_FRINGE_1", 0.01f);
        PARTICLE_DURATION_MIN.put("FLASH_CORE_1", 0.01f);
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 1.0f);
        PARTICLE_DURATION_MAX.put("FLASH_FRINGE_1", 0.01f);
        PARTICLE_DURATION_MAX.put("FLASH_CORE_1", 0.01f);
    }
    ...
    //Instantiator
    public BreakerMuzzleFlashScript() {}

    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {

        //Run our rotation script, and get one if we don't already have one
        if (rotaryScript == null) {
            rotaryScript = new rotaryAnimation();
        }
        rotaryScript.advance(amount, engine, weapon);
