...
public class StahlZwillingMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {

    private StahlhagelAmmoScript ammoScript = null;
    ...
    */
    ...
    //Instantiator
    public StahlZwillingMuzzleFlashScript() {}
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (ammoScript == null) {
            ammoScript = new StahlhagelAmmoScript();
        }
