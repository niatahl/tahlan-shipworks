...
public class StrahlhammerMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {

    private BeamOscillationScript oscilationScript = null;
    ...
    */
    ...
    //Instantiator
    public StrahlhammerMuzzleFlashScript() {}
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (oscilationScript == null) {
            oscilationScript = new BeamOscillationScript();
        }
