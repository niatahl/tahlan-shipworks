...
public class TSW_CooperativeProtocolsKori extends BaseHullMod {
    ...
    public void advanceInCombat(ShipAPI ship, float amount) {
        ...
        for (ShipAPI testShip : CombatUtils.getShipsWithinRange(ship.getLocation(), AURA_RANGE)) {
            if (testShip.getVariant().getHullMods().contains("TSW_cooperative_protocols_yuki") && !testShip.isHulk() && testShip.getOwner() == ship.getOwner()) {
                hasYuki = true;
                break;
            }
        }
