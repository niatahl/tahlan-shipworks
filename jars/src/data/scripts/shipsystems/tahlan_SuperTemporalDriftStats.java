...
public class tahlan_SuperTemporalDriftStats extends BaseShipSystemScript {

    private static final Color AFTERIMAGE_COLOR = new Color(255, 63, 0, 60);
    public static final float DAMAGE_MULT = 1f;
    public static final float DPS_MULT = 1f;
    ...
    public static final float ELECTRIC_SIZE = 200.0f;
