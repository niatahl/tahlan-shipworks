...
public class tahlan_HagelsturmMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(8f, 28f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_2", new Vector2f(-8f, 28f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_4", new Vector2f(-8f, 28f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(8f, 29f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_2", new Vector2f(-8f, 29f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_4", new Vector2f(-8f, 29f));
    }
    ...
    static {
        ...
        PARTICLE_COLOR.put("FLASH_ID_3", new Color(160,250,255, 155));
        PARTICLE_COLOR.put("FLASH_ID_4", new Color(160,250,255, 155));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("FLASH_ID_3", 40f);
        PARTICLE_SIZE_MIN.put("FLASH_ID_4", 40f);
    }

    //What's the largest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MAX = new HashMap<>();
    static {
        PARTICLE_SIZE_MAX.put("default", 12f);
        PARTICLE_SIZE_MAX.put("FLASH_ID_3", 40f);
        PARTICLE_SIZE_MAX.put("FLASH_ID_4", 40f);
    }
    ...
    //Instantiator
    public tahlan_HagelsturmMuzzleFlashScript() {}
