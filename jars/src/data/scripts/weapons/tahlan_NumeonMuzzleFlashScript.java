...
public class tahlan_NumeonMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(-5f, 10f));
        PARTICLE_SPAWN_POINT_TURRET.put("SMOKE_2", new Vector2f(5f, 10f));
        PARTICLE_SPAWN_POINT_TURRET.put("SMOKE_4", new Vector2f(5f, 10f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_FRINGE_2", new Vector2f(5f, 10f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_CORE_2", new Vector2f(5f, 10f));
        PARTICLE_SPAWN_POINT_TURRET.put("SMOKE_6", new Vector2f(5f, 10f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(-3f, 15f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("SMOKE_2", new Vector2f(3f, 15f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("SMOKE_4", new Vector2f(3f, 15f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_FRINGE_2", new Vector2f(3f, 15f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_CORE_2", new Vector2f(3f, 15f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("SMOKE_6", new Vector2f(3f, 15f));
    }
    ...
    static {
        PARTICLE_OFFSET_MAX.put("default", 40f);
        PARTICLE_OFFSET_MAX.put("SMOKE_3", 50f);
        PARTICLE_OFFSET_MAX.put("SMOKE_4", 50f);
        ...
        PARTICLE_OFFSET_MAX.put("SMOKE_5", 3f);
        PARTICLE_OFFSET_MAX.put("SMOKE_6", 3f);
    }
    ...
    //Instantiator
    public tahlan_NumeonMuzzleFlashScript() {}
