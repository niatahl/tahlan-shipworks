...
public class tahlan_StyrixMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(5f, -9f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_2", new Vector2f(-5f, -9f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(5f, 2f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_2", new Vector2f(-5f, 2f));
    }
    ...
    //Instantiator
    public tahlan_StyrixMuzzleFlashScript() {}
