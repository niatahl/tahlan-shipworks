...
public class tahlan_StrahlfaustMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(0f, -0.5f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(0f, 2f));
    }
    ...
    //Instantiator
    public tahlan_StrahlfaustMuzzleFlashScript() {}
