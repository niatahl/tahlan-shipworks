...
public class tahlan_GardasOnHitEffect implements OnHitEffectPlugin {
    ...
    private static final float PARTICLE_SIZE = 100f;
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, CombatEngineAPI engine) {
        ...
        Global.getCombatEngine().applyDamage(target, point,  400f, DamageType.FRAGMENTATION, 0, true, false, null, true);
