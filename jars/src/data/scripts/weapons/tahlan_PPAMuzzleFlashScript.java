...
public class tahlan_PPAMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(7f, 7f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_3", new Vector2f(-7f, 7f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_4", new Vector2f(-7f, 7f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(7f, 7f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_3", new Vector2f(-7f, 7f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_4", new Vector2f(-7f, 7f));
    }
    ...
    static {
        ...
        PARTICLE_COLOR.put("FLASH_ID_2", new Color( 102, 255, 219, 255));
        PARTICLE_COLOR.put("FLASH_ID_4", new Color( 102, 255, 219, 255));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("FLASH_ID_2", 12f);
        PARTICLE_SIZE_MIN.put("FLASH_ID_4", 12f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("FLASH_ID_2", 30f);
    ...
    //Instantiator
    public tahlan_PPAMuzzleFlashScript() {}
