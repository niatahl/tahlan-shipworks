...
public class tahlan_UnstableTPCMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(0f, 10f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(0f, 10f));
    }
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(255,80,40, 165));
    }
