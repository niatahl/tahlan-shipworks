...
public class tahlan_StyrixOnHitEffect implements OnHitEffectPlugin {
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, CombatEngineAPI engine) {
        ...
        Global.getCombatEngine().applyDamage(target, point, critLevel * 100f, DamageType.HIGH_EXPLOSIVE, 0, true, false, null, true);
