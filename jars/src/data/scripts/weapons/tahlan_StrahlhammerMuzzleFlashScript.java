...
public class tahlan_StrahlhammerMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {

    private tahlan_BeamOscillationScript oscilationScript = null;
    ...
    */
    ...
    static {
        PARTICLES_PER_SECOND.put("default", 20f);
        PARTICLES_PER_SECOND.put("FLASH_ID_2", 30f);
        PARTICLES_PER_SECOND.put("FLASH_ID_4", 30f);
    }
    ...
    static {
        PARTICLE_SPAWN_MOMENT.put("default", "FIRING-CHARGEDOWN");
        PARTICLE_SPAWN_MOMENT.put("FLASH_ID_2", "CHARGEUP-FIRING");
        PARTICLE_SPAWN_MOMENT.put("FLASH_ID_4", "CHARGEUP-FIRING");
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(7f, 0f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_3", new Vector2f(-7f, 0f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_4", new Vector2f(-7f, 0f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(7f, 6f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_3", new Vector2f(-7f, 6f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_4", new Vector2f(-7f, 6f));
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put("FLASH_ID_2", "BRIGHT");
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(220,220,220, 185));
        PARTICLE_COLOR.put("FLASH_ID_2", new Color( 255, 130, 160, 255));
        PARTICLE_COLOR.put("FLASH_ID_4", new Color( 255, 130, 160, 255));
    }

    //What's the smallest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MIN = new HashMap<>();
    static {
        PARTICLE_SIZE_MIN.put("default", 7f);
        PARTICLE_SIZE_MIN.put("FLASH_ID_2", 10f);
        PARTICLE_SIZE_MIN.put("FLASH_ID_4", 10f);
    }

    //What's the largest size the particles can have?
    private static final Map<String, Float> PARTICLE_SIZE_MAX = new HashMap<>();
    static {
        PARTICLE_SIZE_MAX.put("default", 14f);
        PARTICLE_SIZE_MAX.put("FLASH_ID_2", 25f);
        PARTICLE_SIZE_MAX.put("FLASH_ID_4", 25f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MAX.put("FLASH_ID_2", 0f);
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("FLASH_ID_2", 0.1f);
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("FLASH_ID_2", 0.2f);
        PARTICLE_DURATION_MAX.put("FLASH_ID_4", 0.2f);
    }
    ...
    static {
        ...
        PARTICLE_OFFSET_MIN.put("FLASH_ID_2", 0f);
        PARTICLE_OFFSET_MIN.put("FLASH_ID_4", 0f);
    }
    ...
    static {
        ...
        PARTICLE_OFFSET_MAX.put("FLASH_ID_2", 0f);
    ...
    static {
        PARTICLE_ARC_FACING.put("default", 180f);
    }
    ...
    //Instantiator
    public tahlan_StrahlhammerMuzzleFlashScript() {}
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (oscilationScript == null) {
            oscilationScript = new tahlan_BeamOscillationScript();
        }
        oscilationScript.advance(amount, engine, weapon);
