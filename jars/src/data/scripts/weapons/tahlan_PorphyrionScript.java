...
public class tahlan_PorphyrionScript implements EveryFrameWeaponEffectPlugin {

    private List<DamagingProjectileAPI> registeredProjectiles = new ArrayList<DamagingProjectileAPI>();

    private tahlan_PorphyrionMuzzleFlashScript muzzleFlashScript = null;
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (muzzleFlashScript == null) {
            muzzleFlashScript = new tahlan_PorphyrionMuzzleFlashScript();
        }
