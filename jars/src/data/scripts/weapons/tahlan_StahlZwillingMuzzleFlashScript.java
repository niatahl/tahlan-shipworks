...
public class tahlan_StahlZwillingMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {

    private tahlan_StahlhagelAmmoScript ammoScript = null;
    ...
    */
    ...
    static {
        ...
        PARTICLES_PER_SECOND.put("FLASH_ID_3", 0f);
        PARTICLES_PER_SECOND.put("FLASH_ID_4", 0f);
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(5f, 18.5f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_2", new Vector2f(-5f, 18.5f));
        PARTICLE_SPAWN_POINT_TURRET.put("FLASH_ID_4", new Vector2f(-5f, 18.5f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(5f, 19.5f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_2", new Vector2f(-5f, 19.5f));
        PARTICLE_SPAWN_POINT_HARDPOINT.put("FLASH_ID_4", new Vector2f(-5f, 19.5f));
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put("FLASH_ID_3", "BRIGHT");
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(220,220,220, 205));
        PARTICLE_COLOR.put("FLASH_ID_3", new Color(160,250,255, 115));
        PARTICLE_COLOR.put("FLASH_ID_4", new Color(160,250,255, 115));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("FLASH_ID_3", 30f);
        PARTICLE_SIZE_MIN.put("FLASH_ID_4", 30f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("FLASH_ID_3", 30f);
        PARTICLE_SIZE_MAX.put("FLASH_ID_4", 30f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("FLASH_ID_3", 0.05f);
        PARTICLE_DURATION_MIN.put("FLASH_ID_4", 0.05f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MAX.put("FLASH_ID_3", 0.05f);
        PARTICLE_DURATION_MAX.put("FLASH_ID_4", 0.05f);
    }
    ...
    //Instantiator
    public tahlan_StahlZwillingMuzzleFlashScript() {}
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        if (ammoScript == null) {
            ammoScript = new tahlan_StahlhagelAmmoScript();
        }
        ammoScript.advance(amount, engine, weapon);
