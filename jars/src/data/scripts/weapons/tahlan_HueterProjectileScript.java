...
public class tahlan_HueterProjectileScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TARGET_REACQUIRE_RANGE = 500f;
	 ...
	 */
	public tahlan_HueterProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
