...
public class tahlan_FusorMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLES_PER_SECOND.put("default", 300f);
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(0f, -7f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(0f, -7f));
    }
    ...
    static {
        PARTICLE_VELOCITY_MIN.put("default", 50f);
    }
    ...
    //Instantiator
    public tahlan_FusorMuzzleFlashScript() {}
