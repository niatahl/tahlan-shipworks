...
public class tahlan_FrayMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        PARTICLE_COLOR.put("FLASH_FRINGE_1", new Color(255, 125, 45));
    ...
    //Instantiator
    public tahlan_FrayMuzzleFlashScript() {}
