...
public class tahlan_BalorProjectileScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public tahlan_BalorProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
