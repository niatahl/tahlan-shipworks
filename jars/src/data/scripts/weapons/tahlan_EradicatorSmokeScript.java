...
public class tahlan_EradicatorSmokeScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(190, 190, 190, 80));
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 0.45f);
    }
    ...
    //Instantiator
    public tahlan_EradicatorSmokeScript() {}
