...
public class tahlan_AetnosMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(225,235,230, 165));
    }
    ...
    static {
        PARTICLE_OFFSET_MIN.put("default", 2f);
    }
    ...
    static {
        PARTICLE_OFFSET_MAX.put("default", 6f);
    }
    ...
    //Instantiator
    public tahlan_AetnosMuzzleFlashScript() {}
