...
public class tahlan_DisparaxOscillationScript implements EveryFrameWeaponEffectPlugin {
    private final float oscillationTimePrim = 0.05f;
    private final float oscillationTimeSec = 0.1f;
